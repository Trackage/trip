...
Trip objects can be imported directly from types defined in packages `adehabitatLT`, `amt`, `eyetrackeRdata`, `mousetrap`, `sf`, and `sp`. When these formats do not have time
