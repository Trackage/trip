...
proj4string(locs) <- " +proj=longlat +datum=WGS84 +datum=WGS84 +no_defs +towgs84=0,0,0"
...
##proj4string(dat) <- CRS("+proj=longlat +datum=WGS84 +datum=WGS84 +no_defs +towgs84=0,0,0")
