...
The trip package was born as an extension to the [sp](https://CRAN.r-rproject.org/package=sp) package. We could leverage many features from the `Spatial` classes. 
...
The SpatiaTemporal Task View is in need a massive update for the Moving objects, trajectories section see this list here: https://gist.github.com/mdsumner/0a3cb0e58bf9d37b782943ac269e1eff. 
